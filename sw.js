...
// Bump this on every deploy. Also update the matching "v9 · Dr. Sajid
// Mahmood · Hazara University" text in index.html's mobile-menu footer -
// that's the only place a user can visually confirm which build loaded.
const CACHE_NAME = 'alturath-hub-cache-v9';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
